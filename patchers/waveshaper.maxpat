...
,
					...
					"patching_rect" : [ 307.0, 170.0, 150.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-19",
					"items" : [ "(Source)", ",", "cosine", ",", "sound", "file" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 178.0, 66.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 205.0, 223.0, 68.0, 22.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 468.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 288.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 602.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 229.5, 178.0, 66.0, 22.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 13.0, 258.0, 27.0 ],
					"text" : "Waveshaper :: Gloubi-boulga"
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 80.0, 145.5, 44.0, 22.0 ],
													"text" : "history"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 112.5, 61.0, 22.0 ],
													"text" : "mix 0.999"
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 89.5, 177.5, 135.5, 177.5, 135.5, 101.5, 101.5, 101.5 ],
													"source" : [ "obj-14", 0 ]
												}
...
,
					"patching_rect" : [ 205.0, 328.0, 36.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 281.0, 150.0, 22.0 ]
				}
